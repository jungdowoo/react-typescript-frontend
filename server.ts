...
app.use(cors({
    origin: ["https://jungdowoo.store", "http://jungdowoo.store", "https://localhost", "http://localhost", "http://localhost:8080"],
...
app.listen(port, () => {
    console.log(`Server is running on https://jungdowoo.store/:${port}`);
});
